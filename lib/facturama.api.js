...
function facturama(baseData) {
    ...
    var facturamaObject = {
        Clients: {
            ...
            Update: function (id, data, callback, callbackError,statusCode) {
	...
	Retentions: {
		Create: function (data, callback, callbackError) {
        		postSyncWithData("retenciones", data, callback, callbackError);
      		},
      		Get: function (id, callback) {
        		return retrieve("retenciones", id, callback);
      		},
	}
    };
